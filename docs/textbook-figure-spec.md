...
最終更新: 2026-07-18（v2.16: 第9・10章もグローバルIP厳密表現へ描き直し。静的NATを図で実演し全章の宛先表記を一貫）
