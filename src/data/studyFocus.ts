...
export const categoryFocus: CategoryFocus[] = [
  ...
  { categoryId: 'routing', afternoonKeywords: ['ルーティング'], textbookChapterId: 'routing' },
  ...
  { categoryId: 'load-balancer', afternoonKeywords: ['HTTP・CDN'], textbookChapterId: 'lb-proxy-cdn' },
  ...
  // マルチキャストは教科書第18章・ノートともにこの分野が扱う
  { categoryId: 'voip', afternoonKeywords: ['VoIP・IP電話', 'QoS', 'マルチキャスト'], textbookChapterId: 'voip-qos-multicast' },
  ...
  // TLS は「HTTP・CDN」の問題で中心技術として問われる（SWG のTLS復号は proxy 側で数える）
  { categoryId: 'ssl-tls', afternoonKeywords: ['HTTP・CDN'], textbookChapterId: 'web-tls-http' },
