    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: 'figure', figure: webFlowFigure },
        {
          ...
          tone: 'tip',
          title: '送信元も同じ規則',
          body: '同じことが送信元側でも起きています。送信元MACは区間ごとに変わり、送信元IPはPCのまま。科目Bで「送信元／あて先」を問われたら、この対称性を思い出してください。',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'text',
          text: 'ここまでの見方は、そのままネスペ科目Bの構成図読解に使えます。図を渡されたら、まず「どこがLANの境界か」「この通信は次にどの機器へ渡すのか」を探します。',
        },
        {
          kind: 'text',
