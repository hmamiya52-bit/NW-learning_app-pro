...
const mapFigure: PacketFlowFigure = {
  kind: 'packet-flow',
  id: 'ch2-map',
  title: '加わった2台を使って、PCが通信を始めるまで',
  caption: '自分の住所をもらい、相手の住所を調べ、ようやく本番。[[blue:下ごしらえ]]の順に線をたどります。',
  ...
  steps: [
    {
      ...
      packetLabel: '',
      headers: { l2: '', l3: '' },
      explanation: '住所をまだ持たないPCが、配ってくれる相手を全員あてで探します。',
    },
    {
      focus: { type: 'link', a: 'dhcp', b: 'l2sw' },
      packetLabel: '',
      headers: { l2: '', l3: '' },
      explanation: '内部LANのDHCPサーバが応答し、PCの住所が決まります。中身は次の図で。',
    },
    {
    ...
    },
    {
      ...
      packetLabel: '',
      headers: { l2: '', l3: '' },
      explanation: '調べたIPあてに送信。別セグメントなので、まず出口のルータへ。',
    },
    {
      focus: { type: 'link', a: 'r', b: 'web' },
      packetLabel: '',
      headers: { l2: '', l3: '' },
      explanation: 'ルータが転送してWebサーバに到着。2台の下ごしらえが効いています。',
    },
  ],
}
