  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'text',
          text: 'ポート番号は数えきれないほどありますが、科目Bで問われる顔ぶれは決まっています。とくにファイアウォールの許可ルールは、この番号で「何を通すか」を書きます。応用情報レベルで絶対に押さえる分だけ、ここで覚えてしまいましょう。なお表にあるDMZは、社外に公開するサーバを内部から切り離して置く区画のこと（詳しくは第9章）。',
        },
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'text',
          text: 'ネスペ科目Bでは、通信を5つの情報で特定し、「この通信は許可されるか」「どのサービス宛てか」を読ませる問題が定番です。',
        },
        {
          kind: 'callout',
          tone: 'info',
