  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'text',
          text: '宛先ポートで「相手のどのサービスか」、送信元ポートで「自分のどの通信か」を区別します。送信元ポートは、PCが通信のたびに空いている番号から自動で選びます（エフェメラルポート）。結局、1本の通信は次の5つで一意に決まります。[[blue:送信元IP・宛先IP・プロトコル・送信元ポート・宛先ポート]]です。',
        },
