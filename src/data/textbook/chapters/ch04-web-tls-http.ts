...
export const ch04WebTlsHttp: TextbookChapter = {
  ...
  summary:
    'HTTPSの中身は、暗号のトンネルと、その中を流れるHTTPの2階建てです。盗み見となりすましを防ぐTLS、ページを要求して受け取るHTTP、そして1本の接続にやり取りを相乗りさせるHTTP/2。443番の封を開けると、この3つが出てきます。',
  status: 'published',
  estimatedMinutes: 17,
  intro: [
    {
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: 'warn',
          title: '暗号化と本人確認は別の役割',
          body: '暗号化は中身を盗み見させないため、証明書は相手のなりすましを防ぐため。鍵の数学に踏み込まなくても、この2つの役割さえ分かれば先へ進めます。証明書の仕組み（だれが本物だと保証するか）は第13章です。',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: 'figure', figure: httpTableFigure },
        {
          ...
          body: 'HTTPは、1回の要求と応答で完結し、前のやり取りを覚えません（ステートレス）。「ログインしたまま」を保つために、ブラウザとサーバはクッキーなどで合言葉をやり取りします。複数のWebサーバへ振り分けるとき、この合言葉を毎回どのサーバへ届けるか（セッション維持）が課題になります。詳しくは第10章です。',
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: 'tip',
          title: 'ヘッダの圧縮とHTTP/3',
          body: 'HTTP/2は、毎回ほとんど同じ内容が並ぶ[[blue:ヘッダを圧縮]]して、送る量も減らします。さらに新しい[[blue:HTTP/3]]は、TCPではなく[[blue:UDP]]の上で動きます（QUIC）。第3章で見たUDPの身軽さを使って、つなぎ直しを速くする狙いです。名前と「UDPの上で動く」ことが分かっていれば、いまは困りません。',
        },
      ],
    },
    {
