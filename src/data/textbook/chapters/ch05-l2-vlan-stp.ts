  ...
  sections: [
    {
      ...
      blocks: [
        {
          kind: 'text',
          text: 'L2スイッチの仕事は、あて先MACを見て正しいポートへ中継すること。では、どのポートへ送ればよいかは、どうやって分かるのでしょうか。',
        },
        {
          kind: 'text',
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'text',
          text: '1本のケーブルが切れても通信が止まらないよう、スイッチどうしを2本のケーブルでつなぐことがあります（冗長化）。ところが、そのままだと思わぬ問題が起きます。',
        },
        {
          kind: 'text',
