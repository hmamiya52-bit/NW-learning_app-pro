...
export const ch10LbProxyCdn: TextbookChapter = {
  ...
  summary:
    '1台のサーバでは捌けないほどのアクセスを、どう受け止めるか。この章では、代表のIPで受けて複数のサーバへ振り分けるロードバランサ、通信を代わりに行うプロキシ、利用者の近くから配信するCDNを扱います。',
  status: 'published',
  estimatedMinutes: 18,
  intro: [
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: 'figure', figure: l4l7Figure },
        {
          ...
          tone: 'tip',
          title: 'VIPは「代表の住所」',
          body: '社外の利用者が知るのは[[blue:公開用グローバルIP]]だけ、境界の内側では[[blue:VIP]]が代表の住所です。裏のサーバが何台でも、増減しても、外からは1台に見えます。行きも戻りもLBを通るので、科目Bでは「戻りの経路」もあわせて問われます。買い物カゴのように途中経過を持つ通信では、同じ利用者を同じ台へ固定する[[blue:セッション維持]]が要ることもあります（名前だけ押さえれば十分です）。',
        },
      ],
    },
    {
