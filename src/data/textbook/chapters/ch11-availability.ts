  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: 'text',
          text: 'ここに落とし穴があります。稼働側のルータ自体は生きていても、その先の[[amber:外向きの回線]]が切れていたら。合図は流れ続けるので待機側は気づかず、通信だけが行き止まりになります。これを防ぐのが[[blue:トラッキング]]で、見張っている回線が切れたら自分の優先度を下げ、待機側へ譲ります。',
        },
        {
          kind: 'callout',
          tone: 'warn',
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'text',
          text: 'ケーブルが抜ければ機器はすぐ気づきます。やっかいなのは、[[amber:リンクは上がったままなのに通信だけが通らない]]状態です。間にある機器の内部で詰まっている場合などで、これは自分では見えません。',
        },
        {
          kind: 'text',
