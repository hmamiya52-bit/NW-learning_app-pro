...
const tunnelFigure: PacketFlowFigure = {
  ...
  takeaway: 'トンネルの中は[[violet:外側IP]]で運ばれ、[[blue:元のあて先]]は暗号化。第1章の「包む／外す」が拠点間で効きます。',
  ...
  steps: [
    ...
    },
    {
      ...
      packetLabel: '',
      headers: { l2: '', l3: '' },
      explanation: '本社ルータが元のパケットを丸ごと暗号化し、支社ルータあての新IPで包みます。',
    },
    {
      ...
      packetLabel: '',
      headers: { l2: '', l3: '' },
      explanation: '暗号トンネルを渡ります。外から見えるあて先は外側のIPだけ。中身は隠れます。',
    },
    {
      ...
      packetLabel: '',
      headers: { l2: '', l3: '' },
      explanation: '支社ルータが包みを外し、暗号を解いて元のパケットを取り出します。',
    },
    {
