...
export const ch15Ipv6: TextbookChapter = {
  ...
  title: 'IPv6',
  summary:
    'IPv4の枯渇を、世界はNATでしのいできました。その根本解決が、アドレスを128ビットに増やしたIPv6です。16進8グループの表記と::の省略ルール、前半・後半の構造、ARPの仕事を引き継ぐNDP、DHCPなしの自動設定SLAAC、そして現実的な移行方法のデュアルスタック。長さは4倍でも、住所として使う考え方はIPv4と変わりません。',
  status: 'published',
  estimatedMinutes: 12,
  intro: [
    {
  ...
  sections: [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: 'tip',
          title: '::が1か所だけの理由',
          body: 'もし::を2か所に使うと、それぞれに0のグループが何個入るのか復元できなくなります。だから[[green:::は1つのアドレスに1回だけ]]。省略を戻す問題は科目Bの定番です。',
        },
      ],
    },
    {
