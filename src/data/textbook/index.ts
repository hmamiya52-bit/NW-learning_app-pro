...
const DRAFTS: [number, string, string, string][] = [
  ...
  [6, 'routing-ospf', 'ルーティング基礎・OSPF', '経路表と動的ルーティングの考え方を扱います。'],
  [7, 'bgp-internet', 'BGP・インターネット接続', 'ASとBGP、外部到達性を扱います。'],
  ...
  [17, 'voip-qos-multicast', 'VoIP・QoS・マルチキャスト', '音声・品質制御・配信を扱います。'],
  [18, 'iot-lpwa-coap', 'IoT・LPWA・CoAP', '省電力通信と軽量プロトコルを扱います。'],
