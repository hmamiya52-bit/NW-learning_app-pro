...
import { ch20AfternoonReading } from './chapters/ch20-afternoon-reading'
import type { TextbookChapter } from './types'

export type { TextbookChapter, Block, Section, Figure } from './types'

// 全20章公開済み。docs/textbook-curriculum-design.md のマップ（4部構成・構成図の段階的成長）の
// 順序＝学習の積み上げ＋構成図が育つ順。
export const textbookChapters: TextbookChapter[] = [ch01Osi, ch02DnsDhcp, ch03TcpUdpPort, ch04WebTlsHttp, ch05L2VlanStp, ch06IpSubnet, ch07Routing, ch08InternetNatBgp, ch09SecurityFwDmz, ch10LbProxyCdn, ch11Availability, ch12VpnWanSdwan, ch13AuthSsoPki, ch14WirelessLan, ch15Ipv6, ch16Mail, ch17VirtualizationCloud, ch18VoipQosMulticast, ch19Operations, ch20AfternoonReading].sort((a, b) => a.order - b.order)
