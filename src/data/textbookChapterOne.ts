...
const companyNetworkBase = {
  ...
  links: [
    {
      id: 'l3sw-l2sw',
      points: [{ x: 445, y: 327 }, { x: 505, y: 324 }],
      tone: 'sky',
    },
    {
      id: 'l2sw-pc',
      points: [{ x: 205, y: 327 }, { x: 320, y: 327 }],
      tone: 'sky',
    },
    {
      id: 'l3sw-server-sw',
      points: [{ x: 675, y: 324 }, { x: 710, y: 327 }],
      tone: 'amber',
    },
    {
      id: 'server-sw-web',
      points: [{ x: 830, y: 327 }, { x: 840, y: 272 }],
      tone: 'amber',
    },
  ],
  ...
  steps: [
    {
      ...
      packetLabel: 'TCP SYN',
      activeLinkIds: ['l2sw-pc'],
      packet: { from: { x: 250, y: 327 }, to: { x: 285, y: 327 } },
      description:
    ...
    },
    {
      ...
      packetLabel: 'TCP SYN',
      activeLinkIds: ['l3sw-l2sw'],
      packet: { from: { x: 450, y: 327 }, to: { x: 495, y: 324 } },
      description:
    ...
    },
    {
      ...
      packet: { from: { x: 680, y: 324 }, to: { x: 700, y: 326 } },
      description:
    ...
    },
    {
      ...
      packet: { from: { x: 832, y: 326 }, to: { x: 836, y: 300 } },
      description:
    ...
    },
    {
      ...
      packetLabel: '受信',
      activeLinkIds: ['server-sw-web'],
      packet: { from: { x: 836, y: 300 }, to: { x: 836, y: 282 } },
      description:
...
const vlanNetworkDiagram: ExamNetworkDiagram = {
  ...
  zones: [
    ...
    },
    {
      ...
      height: 220,
      kind: 'dashed',
      caption: '192.168.10.0/24 のブロードキャストドメイン',
      tone: 'sky',
    },
    {
      id: 'l3',
    ...
    },
    {
      ...
      height: 220,
      kind: 'dashed',
      caption: '192.168.20.0/24 のブロードキャストドメイン',
      tone: 'amber',
    },
  ],
  nodes: [
    { id: 'pc-a', label: 'PC-A', caption: 'VLAN 10', x: 105, y: 100, width: 120, height: 50, role: 'pc', tone: 'sky' },
    { id: 'pc-b', label: 'PC-B', caption: 'VLAN 10', x: 105, y: 175, width: 120, height: 50, role: 'pc', tone: 'sky' },
    { id: 'l2sw-vlan', label: 'L2SW', caption: 'アクセス/トランク', x: 405, y: 135, width: 150, height: 58, role: 'switch', tone: 'emerald' },
    { id: 'l3sw-vlan', label: 'L3SW', caption: 'SVIでL3転送', x: 650, y: 135, width: 155, height: 58, role: 'router', tone: 'blue' },
    { id: 'web-vlan', label: 'Webサーバ', caption: 'VLAN 20', x: 900, y: 145, width: 125, height: 50, role: 'server', tone: 'amber' },
    { id: 'vlan10-pc-a', label: 'PC-A', caption: '192.168.10.10', x: 100, y: 430, width: 125, height: 52, role: 'pc', tone: 'sky' },
    { id: 'vlan10-pc-b', label: 'PC-B', caption: '192.168.10.11', x: 100, y: 500, width: 125, height: 52, role: 'pc', tone: 'sky' },
    { id: 'vlan-gw-10', label: 'SVI 10', caption: 'GW 192.168.10.1', x: 550, y: 415, width: 135, height: 56, role: 'router', tone: 'blue' },
    { id: 'vlan-gw-20', label: 'SVI 20', caption: 'GW 192.168.20.1', x: 550, y: 490, width: 135, height: 56, role: 'router', tone: 'blue' },
    { id: 'vlan20-web', label: 'Webサーバ', caption: '192.168.20.20', x: 860, y: 455, width: 135, height: 56, role: 'server', tone: 'amber' },
  ],
  links: [
    {
      id: 'pc-a-l2sw',
      points: [{ x: 225, y: 125 }, { x: 405, y: 158 }],
      tone: 'sky',
    },
    {
      id: 'pc-b-l2sw',
      points: [{ x: 225, y: 200 }, { x: 405, y: 170 }],
      tone: 'sky',
    },
    {
      id: 'l2sw-l3sw-trunk',
      points: [{ x: 555, y: 164 }, { x: 650, y: 164 }],
      label: 'トランク',
      tone: 'emerald',
      labelPosition: { x: 602, y: 135 },
    },
    {
      id: 'l3sw-web',
      points: [{ x: 805, y: 164 }, { x: 900, y: 170 }],
      tone: 'amber',
    },
    {
      id: 'logical-vlan10-to-svi',
      points: [{ x: 225, y: 456 }, { x: 550, y: 443 }],
      label: '宛先MACはSVI10',
      tone: 'sky',
      labelPosition: { x: 390, y: 420 },
    },
    {
      id: 'svi10-svi20',
      points: [{ x: 618, y: 471 }, { x: 618, y: 490 }],
      label: 'L3判断',
      tone: 'blue',
      labelPosition: { x: 690, y: 475 },
    },
    {
      id: 'logical-vlan20',
      points: [{ x: 685, y: 518 }, { x: 860, y: 483 }],
      label: '宛先MACはWebサーバ',
      tone: 'amber',
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        'この図のL3SWは、内部LAN側に192.168.10.1、サーバLAN側に172.16.0.1を持つL3の境界として描いています。PCが最初にL2フレームを渡す相手は、内部LAN側の192.168.10.1です。',
    ...
    },
    {
      ...
      body: [
        ...
        'この図では、PC-AからWebサーバへ通信する例として、PC-AがまずSVI 10宛てのL2フレームを送り、L3SWがIPヘッダを見てVLAN 20側へ新しいL2フレームとして送り出す流れを示しています。',
      ],
