...
const companyNetworkBase = {
  ...
  links: [
    {
      id: 'internet-fw',
      points: [{ x: 490, y: 100 }, { x: 490, y: 150 }],
      label: '外部接続',
      tone: 'slate',
      labelPosition: { x: 530, y: 125 },
    },
    {
      id: 'fw-l3sw',
      points: [{ x: 495, y: 198 }, { x: 495, y: 300 }],
      label: '社内側',
      tone: 'blue',
      labelPosition: { x: 535, y: 250 },
    },
    {
      id: 'l3sw-l2sw',
      points: [{ x: 400, y: 327 }, { x: 345, y: 364 }],
      label: '内部LAN',
      tone: 'sky',
      labelPosition: { x: 372, y: 352 },
    },
    {
      id: 'l2sw-pc',
      points: [{ x: 240, y: 364 }, { x: 205, y: 414 }],
      label: '端末収容',
      tone: 'sky',
      labelPosition: { x: 205, y: 380 },
    },
    {
      id: 'l2sw-dns',
      points: [{ x: 240, y: 364 }, { x: 205, y: 324 }],
      dashed: true,
      tone: 'violet',
    },
    {
      id: 'fw-dmz-sw',
      points: [{ x: 550, y: 174 }, { x: 600, y: 174 }, { x: 600, y: 365 }, { x: 735, y: 365 }],
      label: 'DMZ側',
      tone: 'amber',
      labelPosition: { x: 592, y: 152 },
    },
    {
      id: 'dmz-sw-web',
      points: [{ x: 795, y: 342 }, { x: 850, y: 308 }],
      label: '公開Web',
      tone: 'amber',
      labelPosition: { x: 855, y: 328 },
    },
    {
      id: 'dmz-sw-dns',
      points: [{ x: 795, y: 342 }, { x: 703, y: 308 }],
      dashed: true,
      tone: 'violet',
    },
  ],
...
const webFlowDiagram: ExamNetworkDiagram = {
  ...
  steps: [
    ...
    },
    {
      ...
      packet: { from: { x: 570, y: 190 }, to: { x: 745, y: 365 } },
      description:
    ...
    },
    {
      ...
      packet: { from: { x: 810, y: 330 }, to: { x: 850, y: 308 } },
      description:
...
const vlanNetworkDiagram: ExamNetworkDiagram = {
  ...
  links: [
    ...
    {
      id: 'logical-vlan10-a',
      points: [{ x: 210, y: 428 }, { x: 435, y: 413 }],
      label: 'VLAN 10内',
      tone: 'sky',
      labelPosition: { x: 325, y: 388 },
    },
    {
      id: 'logical-vlan10-b',
      points: [{ x: 325, y: 428 }, { x: 435, y: 413 }],
      tone: 'sky',
    },
    {
      id: 'svi10-svi20',
      ...
      diagrams: [
        {
          ...
          rows: [
            ...
            },
            {
              ...
              scope: '端末上の通信。FWの許可条件やサーバの待受ポートとして読む',
              example: 'TCP/443',
              examHint: 'HTTPS通信なら宛先ポート443。FWの許可ルールではIPアドレスと一緒に問われやすい。',
              accent: 'amber',
            },
          ],
        },
